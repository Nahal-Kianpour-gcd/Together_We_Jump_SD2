...
public class HelpMethodsTest {
    ...
    void testCanMoveToWalkableTile() {
        ...
        boolean result = HelpMethods.CanMoveHere(0, 0, tileSize, tileSize, mockLevel, 0, 0);
    ...
    void testBlockedByTileAbove() {
        ...
        int x = 1 * tileSize;
        int y = 2 * tileSize;
        boolean result = HelpMethods.CanMoveHere(x, y, tileSize, tileSize, mockLevel, 0, -1);
    ...
    void testBlockedByTileFromLeft() {
        ...
        int x = 2 * tileSize;
        int y = 3 * tileSize;
        boolean result = HelpMethods.CanMoveHere(x, y, tileSize, tileSize, mockLevel, -1, 0);
    ...
    void testBlockedByOutOfBounds() {
        ...
        boolean result = HelpMethods.CanMoveHere(-10, 0, tileSize, tileSize, mockLevel, -1, 0);
